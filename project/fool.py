...
def fool_text_classifier():
    ...
    if args.model == "word_cnn":
        ...
        model = lstm(dataset)
    model_path = r'./fool_result/backup/{}.dat_15epoch_sn'.format(args.model)
    ...
    adv_text_path = r'./fool_result/{}/{}/adv_{}_20epoch.txt'.format(dataset, args.model, str(clean_samples_cap))
    change_tuple_path = r'./fool_result/{}/{}/change_tuple_{}_20epoch.txt'.format(dataset, args.model, str(clean_samples_cap))
